...
var assignment = parameters[1].split("=")[1];
...
socket.on('connect', function() {
	...
	socket.emit("new teacher", {subject:subject, group:group, assignment:assignment});
	socket.emit("userList", {subject:subject, group:group});
});
