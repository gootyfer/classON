//Load subject and assignment id
var scripts = document.getElementsByTagName('script');
var myScript = scripts[scripts.length - 1];
var questionIndex = myScript.src.indexOf('?');
var querystring = myScript.src.substring(questionIndex);
var arrayParams = querystring.split("&");
var subjectArray = arrayParams[0].split("=");
var subject = subjectArray[1];
var assignmentArray = arrayParams[1].split("=");
var assignment = assignmentArray[1];

//TODO: ejecutar cuando se cargue jQuery
//TODO: al indicar progreso, comprobar que no se está en la cola de peticiones
//Load sections
var sections = document.getElementsByTagName("section");
var contents = $("div.adagio_page_content");
//TODO: fixme
var sections = $("div.activity > div.workplan > div.section");
sections += $("div.activity > div.workplan > div.section > div.section");
...
var header = $("div.adagio_page_header_level4");
var footer = $("div.adagio_page_footer");
...
function checkUsers(callback){
	if(!socket){
		...
		socket.on('connect', function() {
			//TODO: send {userNames:userNames, assignment: assignment, subject: subject}
			//TODO: send station if necessary
